...
public class RecommendationRulesMain {
	...
	public static String getHTMLRecommendations(String version, String code, OntologyManagement om){
		...
		for(GenotypeElement ge: patientGenotype){
		...
		htmlPage = generateResultHTMLPage(criticalRecommendationsHTML, recommendationsHTML, allelesHTML, version, code);
		return htmlPage;
	}
	...
	private static String generateResultHTMLPage(String criticalRecommendations, String allRecommendations, String inferredAlleles, String version, String code){
		String resultHTML= "";
		resultHTML+="<!DOCTYPE html>\n";
		resultHTML+="<html>\n";
		resultHTML+="<head>\n";
	 ...
	 * */	
	private static String revert_label(String label,String id){
