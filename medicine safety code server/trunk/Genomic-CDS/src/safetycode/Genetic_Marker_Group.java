...
public interface Genetic_Marker_Group extends Comparable<Genetic_Marker_Group>{
	 ...
	 * */
	public GenotypeElement getGenotypeElement(int position) throws VariantDoesNotMatchAnAllowedVariantException;
