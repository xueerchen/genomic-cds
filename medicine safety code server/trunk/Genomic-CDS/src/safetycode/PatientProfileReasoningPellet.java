...
public class PatientProfileReasoningPellet extends Thread {
	
	private HashMap<String,HashSet<String>> list_recommendations;
	private IRI documentIRI;
	
	public PatientProfileReasoningPellet(HashMap<String,HashSet<String>> list_recommendations, IRI documentIRI){
	...
	public void run() {
		try {
			...
			System.out.println("Reasoner pellet done.");
