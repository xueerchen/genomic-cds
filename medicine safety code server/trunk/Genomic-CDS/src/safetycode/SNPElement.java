...
/**
 * This class represents a single SNP variation. 
 * 
...
public class SNPElement implements GenotypeElement {
	...
	/**
	 * Similar to compareTo of String class but using a different string order.  The order of the variants in the SNP combination is: (1) The "null;null"; (2) The "D" of deletion; (3) single-nucleotides in alphabetical order "A;A","A;C","A;G","A;T", ...; and (4) multi-nucleotides, first the shorter ones in alphabetical order. 
	 * 
