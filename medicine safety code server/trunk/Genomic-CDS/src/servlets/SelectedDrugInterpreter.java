...
public class SelectedDrugInterpreter extends HttpServlet {
     ...
     */
    public SelectedDrugInterpreter() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String[] checkboxNamesList= request.getParameterValues("drugName");
		
		if(checkboxNamesList == null || checkboxNamesList.length == 0){
		...
		if(cache!=null && cache.isKeyInCache(code)){	
			...
			String templateString = myStringReader.readFile(path+"selectedDrugsAlleleInterpretation.html");
