...
Execution:
d:\> java -jar d:/Genomic-CDS/ProcessRawData.jar input ontology



3. clearCache.jar 
Description: It clear the content of the server cache. It must be used when the ontology changes. It does not need any parameters.

Execution:
d:\> java -jar d:/Genomic-CDS/clearCache.jar 